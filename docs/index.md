...
![Program Execution of Pickling - PyCharm](https://github.com/RFear/IntroToProg-Python-Mod07/blob/main/docs/images/pickling_pycharm.png "Program Execution of Pickling - PyCharm")

Figure 1: Program Execution of Pickling - PyCharm

The program execution in the PyCharm environment is shown in Figure 2.
![Program Execution of Pickling - Command Window](https://github.com/RFear/IntroToProg-Python-Mod07/blob/main/docs/images/pickling_cmd.png "Program Execution of Pickling - Command Window")
...
![Content in pickle_file.txt](https://github.com/RFear/IntroToProg-Python-Mod07/blob/main/docs/images/pickling_file.png "Content in pickle_file.txt")
...
[DataCamp info about pickling](https://www.datacamp.com/community/tutorials/pickle-python-tutorial)

[GeeksForGeeks inof about pickling](https://www.geeksforgeeks.org/understanding-python-pickling-example/)
...
![Try-Except Code Block Logic](https://github.com/RFear/IntroToProg-Python-Mod07/blob/main/docs/images/strut_error_handling_logic.png "Program Execution of Pickling - Command Window")
...
![Program Execution of Structured Error Handling - PyCharm](https://github.com/RFear/IntroToProg-Python-Mod07/blob/main/docs/images/struct_error_hand_pycharm.png "Program Execution of Structured Error Handling - PyCharm")
...
![Program Execution of Structured Error Handling - Command Window](https://github.com/RFear/IntroToProg-Python-Mod07/blob/main/docs/images/struct_error_hand_cmd.png "Program Execution of Structured Error Handling - Command Window")
