...
![Program Execution of Pickling - Command Window](rfear.github.io/IntroToProg-Python-Mod07/docs/images/pickling_cmd.png "Program Execution of Pickling - Command Window")  
...
![Content in pickle_file.txt](rfear.github.io/IntroToProg-Python-Mod07/docs/images/pickling_file.png "Content in pickle_file.txt")  
...
![Try-Except Code Block Logic](rfear.github.io/IntroToProg-Python-Mod07/docs/images/strut_error_handling_logic.png "Program Execution of Pickling - Command Window")  
...
```
*Structured Error Handling Example in Python*

### Program Execution
The program execution in the PyCharm environment is shown in Figure 5.
![Program Execution of Structured Error Handling - PyCharm](rfear.github.io/IntroToProg-Python-Mod07/docs/images/struct_error_hand_pycharm.png "Program Execution of Structured Error Handling - PyCharm")  
...
![Program Execution of Structured Error Handling - Command Window](rfear.github.io/IntroToProg-Python-Mod07/docs/images/struct_error_hand_cmd.png "Program Execution of Structured Error Handling - Command Window")  
...
![Else/Finally Execution](rfear.github.io/IntroToProg-Python-Mod07/docs/images/struct_error_hand_cmd2.png "Else/Finally Execution")  
